...
//     const cart = new CartsManager("productsCart.json");
//     // const result = await cart.getProductsCarts();

//     const result = await cart.createCart(12);
// //     // const result = await cart.getProductsCartsById(2);
// //     const result = await cart.addProductsInThisCart(1, 1);
//     console.log(result);
// }
